...
def parse_args():
    parser = argparse.ArgumentParser(prog='filter and annotate destruct')

    parser.add_argument('--breakpoints',
                        required=True,
                        help='Path to destruct breakpoints')
    parser.add_argument('--library',
                        required=True,
                        help='Path to destruct breakpoints')
    parser.add_argument('--control_ids',
                        required=True,
                        nargs='*',
                        help='normal ids')
    parser.add_argument('--out_breakpoints',
                        required=True,
                        help='Path to destruct breakpoints')
    parser.add_argument('--out_library',
                        required=True,
                        help='Path to destruct breakpoints')
...
if __name__ == "__main__":
    ARGS=parse_args()
    filter_annotate_breakpoints(ARGS.breakpoints, ARGS.library, ARGS.control_ids, ARGS.out_breakpoints, ARGS.out_library)
